...
if(rs.next())
{
  ...
  qw3= rs.getString(7);
   qw4= rs.getString(8);
   qw5= rs.getString(2);
   String qw6=rs.getString(1);
   session.setAttribute("cart",qw6);
}
else
{
    ...
    <body style="background-image: url('book5.jpg');  " >
        ...
        <div style="width: 30%; height: 270px; background-color: rgba(0,0,0,0.2); margin-top: -380px;margin-left: 900px">
            ...
            <td colspan="1"><font color="white"><%=qw5%>    </font>                </td>
                ...
                <tr>
                    <td><a href="addcart.jsp"><img src="cart3.gif"></a></td>
                    <td><a href="order.jsp"><img src="buy2.gif" width="180"></a></td>
                </tr>
                <tr>
                    <td colspan="1"><font color="white">Wanna Book On Rent??</font></td>
<td colspan=""> <a href="rent.jsp"> <img src="click.gif" width="180"> </a>                 </td>
                </tr>
            </table>
        </div>
                <div style="background-color: black; width: 172px; height: 61px; margin-left: 1351px; margin-top: 228px; border-radius: 20px" >
                    <td><a href="homeuser.jsp"><img src="back.gif" height="61px" style="border-radius: 10px"></a></td>
                </div>
    </body>
</html>